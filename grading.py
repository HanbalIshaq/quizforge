...
QUESTION_TYPES = [
    ...
    ("url", "URL / Website (form field)"),
    ("time", "Time picker (form field)"),
    ("datetime", "Date &amp; Time (form field)"),
    ("slider", "Slider / Range (form field)"),
    ("address", "Full address (street/city/state/zip/country)"),
    ("full_name", "Full name (first + last)"),
    ("file_upload", "File upload (PDF, image, doc — up to 16 MB)"),
    ("signature", "Signature pad (draw to sign)"),
    ("consent", "Terms / Consent checkbox"),
    ("section_break", "Section break / instructions (no answer)"),
